...
namespace RealEstate_Dapper_Api.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public decimal AvergeProductPriceBySale()
        {
        ...
        {
            string query = "Select top(1) City, Count(*) as 'productConut' From Product Group By City order by productConut Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
        ...
        {
            string query = "Select Name, Count(*) 'productConut' From Product Inner Join Employee On Product.EmployeeID = Employee.EmployeeID Group By Name Order By productConut Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
